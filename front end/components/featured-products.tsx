        ...
        <div className="mb-8 relative">
          <div className="flex items-center">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-64 bg-white p-4 rounded-lg shadow-lg">
                ...
                <DropdownMenuSeparator />
                {Array.from(new Set(featuredProducts.map((p) => p.brand))).map((brand) => (
                ...
                <DropdownMenuSeparator />
                {Array.from(new Set(featuredProducts.map((p) => p.size))).map((size) => (
